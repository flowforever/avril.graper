...
var request = require('request').default({jar: true});
...
function Graper(config) {
    ...
    if (this.options.funcs) {
        Object.keys(this.options.funcs).forEach(function (fn) {
            this[fn] = eval(this.options.funcs[fn]);
        }.bind(this));
        this.options.funcs = undefined;
    }
